// Top ~80 Indian cities by population/Swiggy presence, with rough lat/lng
// for the nearest-city resolver. The combobox accepts free-text input too,
// so this list is for fast selection — not an allowlist.
...
export const INDIAN_CITIES: IndianCity[] = [
  ...
  { name: "Saharanpur", state: "Uttar Pradesh", lat: 29.968, lng: 77.551 },
  { name: "Moradabad", state: "Uttar Pradesh", lat: 28.8389, lng: 78.7768 },
  { name: "Bhilai", state: "Chhattisgarh", lat: 21.209, lng: 81.4287 },
